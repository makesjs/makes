...
c`;
  ...
  t.is(preprocess('a/b.html', source, null, ['foo'], 'html'), 'a\nb\nc');
  t.is(preprocess('a/b.html', source, null, ['bar'], 'html'), 'a\nc');
});
...
c`;
  ...
  t.throws(() => preprocess('a/b.html', source, null, ['foo'], 'html'));
  t.throws(() => preprocess('a/b.html', source, null, ['bar'], 'html'));
});
...
c`;
  ...
  t.is(preprocess('a/b.js', source, null, ['foo', 'xx', 'bar'], 'html'), 'a\nb\nd\nf\nc');
  t.is(preprocess('a/b.js', source, null, ['bar'], 'html'), 'a\nc');
  t.is(preprocess('a/b.js', source, null, ['foo', 'xx', 'bar', 'lo'], 'html'), 'a\nb\nd\ne\nf\nc');
});
...
c`;
  ...
  t.is(preprocess('a/b.js', source, null, ['foo']), 'a\nb\nc');
  t.is(preprocess('a/b.js', source, null, ['bar']), 'a\nc');
});
...
c`;
  ...
  t.throws(() => preprocess('a/b.js', source, null, ['foo']));
  t.throws(() => preprocess('a/b.js', source, null, ['bar']));
});
...
test('@if supports one line block comment in js syntax', t => {
  ...
  t.is(preprocess('a/b.js', source, null, ['foo']), 'abc');
  t.is(preprocess('a/b.js', source, null, ['bar']), 'ac');
});

test('@if supports nesting (block comment) in js syntax', t => {
  const source = 'a /* @if foo */b/* @if bar */bad/* @endif */ c/* @if foo */d/* @endif */e/* @endif */f';
  t.is(preprocess('a/b.js', source, null, ['foo']), 'a b cdef');
  t.is(preprocess('a/b.js', source, null, ['bar']), 'a f');
  t.is(preprocess('a/b.js', source, null, ['foo', 'bar']), 'a bbad cdef');
});
...
c`;
  ...
  t.is(preprocess('a/b.js', source, null, ['foo', 'xx', 'bar']), 'a\nb\nd\nf\nc');
  t.is(preprocess('a/b.js', source, null, ['bar']), 'a\nc');
  t.is(preprocess('a/b.js', source, null, ['foo', 'xx', 'bar', 'lo']), 'a\nb\nd\ne\nf\nc');
});
